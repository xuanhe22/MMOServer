...
public class SummaryMonthPo extends BasePropertyVo{
	private static final long serialVersionUID = 6889830712124792641L;
	private Integer id;
	...
	public SummaryMonthPo(SqlRowSet rs){
		this.id = rs.getInt(1);
	...
	{
		return "id,type,channel_key,summary_time,new_user_role_new,new_user_role_exist,dau,day_user_old,day_user_new,pu,pu_new,pu_percentage,darpu,darppu,charge_currency,consume_diamond";
	}
