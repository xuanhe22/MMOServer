 ...
 *
 */
public class BloodMagicFortressEndJob implements Job {

	@Override
	public void execute(JobExecutionContext context) throws JobExecutionException {
		try {
			endBloodMagicFortressContext(context);
		} catch (Exception e) {
			ExceptionUtil.processException(e);
		}
	}
	
	public void endBloodMagicFortressContext(JobExecutionContext context){
		...
		endBloodMagicFortressDispose(id, nextTime);
	}
	
	public void endBloodMagicFortressDispose(Integer id, Long nextTime){
