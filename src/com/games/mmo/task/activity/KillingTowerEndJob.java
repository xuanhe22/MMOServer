 ...
 *
 */
public class KillingTowerEndJob implements Job {

	@Override
	public void execute(JobExecutionContext context) throws JobExecutionException {
		try {
			endKingOfPkContext(context);
		} catch (Exception e) {
			ExceptionUtil.processException(e);
		}
	}
	
	public void endKingOfPkContext(JobExecutionContext context){
		...
		endKingOfPkDispose(id, nextTime);
	}
	
	public void endKingOfPkDispose(Integer id, Long nextTime){
...
//		System.out.println("极限乱斗之王 结束：" +new Date().toLocaleString()+" " +copySceneActivityPo);
