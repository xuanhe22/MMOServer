 ...
 *
 */
public class TeamMonstertInvadeRoom extends DynamicMapRoom {

	public static final int SCENE_ID = 20100026;
	
	public TeamMonstertInvadeRoom(ScenePo scenePo) {
		super(scenePo);
		startThread();
	}
	...
	public void onGameOver() {
		...
		for (RolePo player : joinPlayers) {
			...
			if(award){
				addExp=currentFreshIndex/6*100000;
